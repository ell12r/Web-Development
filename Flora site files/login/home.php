        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="assets/files/timetable.pdf">Download 2023 Academic calendar</a>
                    <a class="btn btn-primary-outline display-4" href="index.html#features14-n"><span class="mobi-mbri mobi-mbri-home mbr-iconfont mbr-iconfont-btn"></span>Home</a></div>
            </div>
        </div>
    </div>
</section>
